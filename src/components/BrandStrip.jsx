...
export default function BrandStrip() {
  ...
  return (
    <section className="relative ">
      {/* fundo escuro ligeiramente inclinado */}
      <div className="absolute inset-0 - bg-[#1f1f1f]" />

      {/* conteúdo em contraskew para ficar direito */}
              ...
              <div className="inline-flex items-center gap-10 pr-6">
                {LOGOS.map((src) => (
                  <img
                    ...
                    src={src}
                    alt=""
                    className="h-10 object-contain invert brightness-0 opacity-90"
                    loading="lazy"
                    decoding="async"
                  />
                ))}
            ...
            <div className="hidden md:grid grid-cols-6 gap-10 items-center justify-items-center">
              {LOGOS.map((src) => (
                <img
                  ...
                  src={src}
                  alt=""
                  className="h-12 object-contain invert brightness-0 opacity-90"
                  loading="lazy"
                  decoding="async"
                />
              ))}
