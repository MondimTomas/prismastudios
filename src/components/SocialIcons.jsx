export default function SocialIcons({ className = "" }) {
    const ICONS = [
      { name: "Instagram", href: "https://www.instagram.com/prisma_studios.pt/", svg: (
      ...
      { name: "Facebook", href: "https://facebook.com/", svg: (
      ...
      { name: "LinkedIn", href: "https://www.linkedin.com/", svg: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
          <path d="M4.98 3.5A2.5 2.5 0 1 1 5 8.5a2.5 2.5 0 0 1-.02-5zM3 9h4v12H3zM10 9h3.8v1.64h.05c.53-.95 1.82-1.95 3.75-1.95 4.01 0 4.75 2.64 4.75 6.07V21h-4v-4.9c0-1.17-.02-2.67-1.63-2.67-1.63 0-1.88 1.27-1.88 2.58V21h-4z"/>
        </svg>
      )},
      { name: "TikTok", href: "https://www.tiktok.com/", svg: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
      ...
      { name: "YouTube", href: "https://youtube.com/", svg: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
    ...
    // gap-2 para aproximar; sem bg/caixa; cor suave com hover
    return (
