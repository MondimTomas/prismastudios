 ...
 *  thumbs leves em /public/thumbs
 */
const VIDEOS = [
  { title: "Podcast – Episódio Piloto",  src: "https://www.youtube.com/watch?v=dQw4w9WgXcQ", thumb: "/thumbs/yt1.jpg", duration: "18:32", platform: "YouTube" },
  { title: "Review de Produto (Studio)",  src: "/videos/review-produto.mp4",     thumb: "/thumbs/yt2.jpg", duration: "07:45", platform: "MP4" },
  { title: "Vlog Outdoor – Creative Day", src: "https://youtu.be/9bZkp7q19f0",   thumb: "/thumbs/yt3.jpg", duration: "05:12", platform: "YouTube" },
  { title: "Tutorial – Setup de Luz",     src: "/videos/tutorial-luz.mp4",       thumb: "/thumbs/yt4.jpg", duration: "09:01", platform: "MP4" },
];
        ...
        <section className="mt-12 grid lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-7">
            ...
            <ul className="mt-6 space-y-3">
              {[
                "Roteiro/estrutura com hooks, capítulos e CTAs pensados para retenção.",
                "Estúdio com luz e som controlados (teleprompter opcional).",
                "Outdoor com captação ágil e estabilizada; B-roll cinematográfico.",
                "Edição + motion/titling, color grading e som limpo (voz + música).",
                "Pacotes de thumbnails, capítulos e versões curtas (Shorts/Reels).",
              ].map((t) => (
          ...
          <div className="lg:col-span-5">
            <div className="rounded-2xl bg-[#EBEBEB] text-[#2D2C2A] p-6 md:p-7 ring-1 ring-black/5 shadow-[0_12px_30px_rgba(0,0,0,.25)]">
              ...
              <ul className="space-y-2 leading-relaxed text-[15px]">
                ...
                <li><strong>Entrega:</strong> MP4 H.264/H.265 (sRGB) + 2–3 thumbnails e ficheiro .txt com título/descrição/hashtags.</li>
              </ul>
              <div className="mt-4 text-sm text-black/70">
                SLAs: prévias em 48–72h; versão final em 5–10 dias úteis (consoante a complexidade).
              </div>
            </div>
          </div>
        </section>
